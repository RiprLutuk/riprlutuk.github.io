...
<head>
	<meta charset="utf-8">
	<title>Web Blog | RiprLutuk.Ltd</title>
	<meta http-equiv="X-UA-Compatible" content="IE=Edge">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="keywords" content="Ripr Lutuk, Website Developer, Android Developer, UI/UX, IT Analyst, Data Analyst, Skripsi, IT Support">
	<meta name="description" content="Ripr Lutuk, Website Developer, Android Developer, UI/UX, IT Analyst, Data Analyst, Skripsi, IT Support">
    
	<link href='http://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
	<link rel="stylesheet" href="css/animate.min.css">
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="css/font-awesome.min.css">		
	<link rel="stylesheet" href="css/ripr.css">
</head>
	...
	<nav class="navbar navbar-fixed-top custom-navbar" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand">Ripr Lutuk</a>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<p class="wow bounceIn">
						<?php echo "Copyright © " . (int) date('Y'). "  Design UI/UX, Web and Mobile Developers.";?><br />
                		Re Design: <a rel="nofollow noopener" href="https://riprlutuk.github.io/"><span>Ripr Lutuk</span></a></p>
				</div>
			</div>
		</div>
	</footer>
